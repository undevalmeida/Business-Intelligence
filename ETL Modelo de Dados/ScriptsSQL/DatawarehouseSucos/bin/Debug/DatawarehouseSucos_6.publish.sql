...
GO
PRINT N'Rename refactoring operation with key e595bb60-b1d4-45f5-b8e3-33af37e667e5 is skipped, element [dbo].[Dim_Tempo].[Id] (SqlSimpleColumn) will not be renamed to Cod_Dia';


GO
PRINT N'Rename refactoring operation with key 8a102b38-f2e0-42d3-aa25-4381957cbb9c is skipped, element [dbo].[Dim_Tempo].[E_Dia_Semana] (SqlSimpleColumn) will not be renamed to Tipo_Dia';
